    ...
    editor.BlockManager.add('form-salesforce-core', {
        ...
        content: `
            <section class="form-core-section">
                ...
                <div style="display:none !important;" class="sfmc-snippet-logic" data-gjs-selectable="false" data-gjs-hoverable="false">
                    %%=ContentBlockByKey("SFCore_Form_Logic_Snippet")=%%
                </div>
                ...
                <div class="form-core-container">
                    ...
                    <div style="display:none !important;" class="sfmc-snippet-messages">
                        %%=ContentBlockByKey("SFCore_Form_Messages_Snippet")=%%
                    </div>

                    <form class="sf-core-form" method="POST" action="%%=RequestParameter('PAGEURL')=%%">
                        <input type="hidden" name="submitted" value="true">
                        
                        <div class="form-group-core">
                            <label>École souhaitée</label>
                            <select name="SchoolId" required class="form-select-core">
                                ...
                                <!-- (Placé dans une option cachée pour ne pas casser le HTML de l'aperçu) -->
                                <option style="display:none;" disabled value="hide">
                                    %%=ContentBlockByKey("SFCore_School_Picklist_Snippet")=%%
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="form-group-core">
                            <label>Email</label>
                            <input type="email" name="EmailAddress" required placeholder="jean@exemple.com">
                        </div>

                        <button type="submit" class="form-core-submit">
                            <span>Envoyer au CRM</span>
